...
<meta http-equiv="X-UA-Compatible" content="IE=edge" />
	...
	<link rel="stylesheet" href="/shop/layout/css/right_hidden.css"/>
		...
		<div id="contents" class="left">
			...
			<div module="member_join">
			    ...
			    <div class="ec-base-table typeWrite">
			    	<form id="signUpForm" action="Controller?type=signup" method="post">
			        ...
			        <tbody>
			            <tr class="u_id">
			                <th scope="row">아이디 <img src="/shop/user/account/img/ico_required_blue.gif" alt="필수" /></th>
			                <td><input id="u_id" name="id" class="inputTypeText" type="text" placeholder="아이디"></input>  (영문소문자/숫자, 4~16자) <span id="box"></span></td>
			            </tr>
			            <tr>
			                <th scope="row">비밀번호 <img src="/shop/user/account/img/ico_required_blue.gif" alt="필수" /></th>
			                <td>
			                    <div class="eTooltip">
			                        <input id="passwd1" name="pw1" class="inputTypeText" type="password" placeholder="비밀번호"> 
			                    </div>
			                </td>
			            </tr>
			            ...
			            <tr>
			                ...
			                <td>
			                    <div class="eTooltip">
			                        <input id="passwd" name="pw" class="inputTypeText" type="password" placeholder="비밀번호">  <span id="box2"></span>
			                    </div>
			                </td>
			            </tr>
			            ...
			            <tr>
			                ...
			                <td>
			                    <span id="{$name_contents}"><input id="name" name="name" class="inputTypeText" type="text" placeholder="이름"></span>
			                    <span id="under14Msg" class="displaynone">14세 미만 사용자는 법정대리인 동의가 필요합니다.</span>
			                </td>
			            </tr>
			            <tr>
			                <th scope="row" id="{$name_title}">생년월일 <img src="/shop/user/account/img/ico_required_blue.gif" alt="필수" /></th>
			                <td>
			                    <span id="{$name_contents}"><input id="btd" name="btd" class="inputTypeText" type="text" placeholder="생년월일"></span>
			                    
			                </td>
			            </tr>
			            <tr>
			            	<th>성별 <img src="/shop/user/account/img/ico_required_blue.gif" alt="필수" /></th>
			            	<td>
			            		<label><input type="radio" name="sex" value="0" onclick="getGender()">남성</label>
			            		<label><input type="radio" name="sex" value="1" onclick="getGender()">여성</label>	
			            	</td>
			            </tr>
			            <tr class="{$display_mobile|display}">
			                ...
			                <td>
			                    <input type="text" id="mobile1" name="phone" class="phone"/>
			                     - <input type="text" id="mobile2" name="phone" class="phone"/>
			                     - <input type="text" id="mobile3" name="phone" class="phone"/>
			        
			                </td>
			            </tr>    
			            <tr>
			                <th scope="row">이메일 <img src="/shop/user/account/img/ico_required_blue.gif" alt="필수" /></th>
			                <td><input id="s_email" name="email" class="inputTypeText" type="text" placeholder="이메일"> <span id="{$emailMsg_id}"></span>
								<label for="email2">@</label>
								<input type="text" id="s_email2" name="email">
								<select id="sel_email">
									<option>직접선택</option>
			            ...
			            <tr>
			            	<th>주소 <img src="/shop/user/account/img/ico_required_blue.gif" alt="필수" /></th>
			            	<td id="addr_style">
								<input type="text" id="zip_code" placeholder="우편번호" readonly>
								<input type="button" onclick="checkPost()" value="주소검색"><br><br>
								<input type="text" name="addr" id="addr" placeholder="주소" readonly><br>
								<input type="text" name="addr_d" id="addr_detail" placeholder="상세주소">
								<input type="text" name="addr_d" id="addr_extra" placeholder="참고항목">
							</td>
			            </tr>
			        </tbody>
			        </table>
				...
				<table id="t1">
					<thead>
						<h3>전체 동의</h3>
						<tr class="ec-base-box typeThinBg gStrong">
							<th>
							 	<input type="checkbox" name="checker" id="sAgreeAllChecked"><label for="sAgreeAllChecked"><p><strong>&nbsp;&nbsp;이용약관 및 개인정보수집 및 이용, 쇼핑정보 수신(선택)에 모두 동의합니다.</strong></p></label>
							</th>
			   			 </tr>
			    	</thead>
					<tbody>
			   			 <tr class="ec-base-box typeThinBg agreeArea">
							<td class="content">
			        			<h3>[필수] 이용약관 동의</h3>
			        			...
			        			<p class="check"><span>이용약관에 동의하십니까?</span> <input type="checkbox" id="service_desc" /> 동의함</p>
			        		</td>
			   			 </tr>
			  			  <tr class="ec-base-box typeThinBg agreeArea">
							<td class="content">
...
<script type="text/javascript">
	$(function(){
		$("#u_id").bind("keyup",function(){
			let str = $("#u_id").val().trim();

			if(str.length > 3){
				$.ajax({
					url: "/shop/user/account/check_id.jsp",
					type: "post",
	...
	function reg() {
		...
		let ar1 = document.getElementsByName("email");
		let ar = document.getElementsByName("phone");
		let addr = document.getElementById("addr");
		let addr_ar = document.getElementsByName("addr_d");
		
		let param = "id="+encodeURIComponent(id.value)+
					"&pw="+encodeURIComponent(pw.value)+
					"&name="+encodeURIComponent(name.value)+
					"&btd="+encodeURIComponent(btd.value)+
					"&addr="+encodeURIComponent(addr.value)+
					"&zip_code="+encodeURIComponent(zip_code.value)+
					"&email="+encodeURIComponent(ar1[0].value+"@"+ar1[1].value)+			
					"&addr2="+encodeURIComponent(addr_ar[0].value+" "+addr_ar[1].value)+			
					"&sex="+encodeURIComponent(sex)+
					"&phone="+encodeURIComponent(ar[0].value+"-"+ar[1].value+"-"+ar[2].value);
		...
		$.ajax({
			...
			alert("회원가입이 완료되었습니다.");
			location.replace("Controller?type=login");
		});
	} 
    ...
    function validateForm() {
        const serviceDesc = document.getElementById('service_desc').checked;
        const privacyDesc = document.getElementById('privacy_desc').checked;

        if (!serviceDesc || !privacyDesc) {
            alert('모든 필수 항목에 동의해야 회원가입이 가능합니다.');
            return false;
        }
