...
<script type="text/javascript">
	function sendData(){
		for(var i=0 ; i<document.forms[0].elements.length ; i++){
			...
			console.log(document.forms[0].elements[i].dataset.str+"::"+document.forms[0].elements[i].value)
		}
...
<body>
	<div id="bbs">
	<form action="Controller?type=edit&b_idx=${bvo.getB_idx() }&bc_key=<%=bc_key %>&cPage=${param.cPage}&edit=1" method="post" encType="multipart/form-data">
		...
		<table summary="게시판 글쓰기">
			...
			<tbody>
				<tr>
					<th>제목:</th>
					<td><input type="text" name="title" value="${bvo.getTitle() }" data-str="제목" size="45"/></td>
				</tr>
				<tr>
					<th>이름:</th>
					<td><input type="text" name="u_idx" value="${bvo.getUvo().getName() }" data-str="이름" disabled size="12"/></td>
				</tr>
				<tr>
					<th>내용:</th>
				...
				<tr>
					<th>첨부파일:</th>
					<td>
						<input type="file" name="file" data-str="첨부파일"/>
...
-->
				<tr>
					<td colspan="2">
						...
						onclick="sendData()"/>
						<input type="button" value="목록" onclick="javascript:location.href='Controller?type=list&cPage=${param.cPage}&bc_key=${param.bc_key}'"/>
					</td>
				</tr>
			</tbody>
		</table>
