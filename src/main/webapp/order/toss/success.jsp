  ...
  <head>
    ...
    <section>
		...
		<%
			...
			List<BasketVO> list = uvo.getBasket_list();
			
			SqlSession ss = FactoryService.getFactory().openSession();
			for (BasketVO bvo : list) {
				int res = ss.delete("basket.delete", bvo.getBasket_key());
				if (res > 0) {
					ss.commit();
				}
			} 
		...
		<div class="box_section" style="width: 600px">
            ...
            <div class="p-grid" style="margin-top: 30px">
              <button class="button p-grid-col5" onclick="location.href='http://localhost:8080/shop/Controller?type=index';">홈</button>
