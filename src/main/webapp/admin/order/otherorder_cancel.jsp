...
<div class="optionArea " id="QA_deposit1">
            ...
            <table border="1" summary="">
                ...
                <tr>
                <th scope="row">관리 항목</th>
                    <td colspan="3">
                        <div id="mainSearch">
                        	<div class="keywordSearchSelect">
                                    <select class="fSelect" name="MSK[]" style="width:163px;">
                                                                                    <option value="choice">-관리항목선택-</option>
                                                                                    <option value="order_id" selected="">취소 관리</option>
                                                                                    <option value="ord_item_code">교환 관리</option>
                                                                                    <option value="delivery_code">반품 관리</option>
                                                                                    <option value="invoice_no">환불 관리</option>
                               		 </select>
                        	</div>
                        </div>
                    </td>
