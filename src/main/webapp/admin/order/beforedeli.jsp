                        ...
                        <table border="1" summary="" class="thead">
                            ...
                            <tr>
                                <th scope="col" class="w50" style="display:none;">No</th>
                                                                                                <th scope="col" class="w65" style="">주문일<br>(결제일)</th>
                                <th scope="col" class="w120" style="">주문번호
                                                                    </th>
                                <th scope="col" class="w80" style="">주문자 <div class="cTip eSmartMode" code="OD.OF.DD.200"></div></th>
                                <th scope="col" class="w80" style="display:none;">
                                    사업자 회원 정보
                                </th>
                                <th scope="col" class="w50" style="">묶음선택</th>
                                <th scope="col" class="w35"><input type="checkbox" id="allChk"></th>
                                <th scope="col" class="w140" style="">운송장정보</th>
                                                                <th scope="col" class="w60" style="display:none; ">배송비</th>
                                ...
                                <th scope="col" class="w100" style="display:none;">자체 품목코드</th>
                                <th scope="col" class="w30" style="width:px;">수량</th>
                                <th scope="col" class="w80" style="display:none;">판매가</th>
                                <th scope="col" class="w100" style="">
                                    상품구매금액
                                                                    </th>
                                                                <th scope="col" class="w180" style="display:none;">주문 라벨</th>
                                <th scope="col" class="w100" style="display:none;">총 상품구매금액</th>
